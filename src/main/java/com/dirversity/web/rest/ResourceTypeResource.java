...
/**
 * REST controller for managing {@link com.dirversity.domain.ResourceType}.
 */
@RestController
@RequestMapping("/api")
public class ResourceTypeResource {
    ...
    public ResponseEntity<ResourceTypeDTO> createResourceType(@Valid @RequestBody ResourceTypeDTO resourceTypeDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ResourceTypeDTO> updateResourceType(@Valid @RequestBody ResourceTypeDTO resourceTypeDTO) throws URISyntaxException {
    ...
    public ResponseEntity<List<ResourceTypeDTO>> getAllResourceTypes(Pageable pageable) {
        log.debug("REST request to get a page of ResourceTypes");
        Page<ResourceTypeDTO> page = resourceTypeService.findAll(pageable);
