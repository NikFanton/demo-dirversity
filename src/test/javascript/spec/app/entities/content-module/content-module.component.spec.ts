...
import { ContentModuleComponent } from 'app/entities/content-module/content-module.component';
...
describe('Component Tests', () => {
  describe('ContentModule Management Component', () => {
    let comp: ContentModuleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContentModuleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contentModules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
